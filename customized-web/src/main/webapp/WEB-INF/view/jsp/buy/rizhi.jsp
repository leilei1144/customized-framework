...
<div style="display: block;text-align: left;">
				  ...
				  <input id="ghid" type="text" default_val="幸运数字" value="幸运数字" style="width:6%;">
				  <input id="ghid" type="text" default_val="账户" value="账户" style="width:6%;">
				  <input id="ghid" type="text" default_val="用户	ID" value="用户ID" style="width:6%;">
				  <input id="ghid" type="text" default_val="用户IP" value="用户IP" style="width:6%;">
				  ...
				  <input style="margin-bottom: 10px; margin-top:10px;" type="button" class="btn btn-primary" id="search-btn" value="改IP">
                        ...
                        <tr role="row">
							...
							<th style="cursor: col-resize; width:6%">是否多期</th>
							<th style="cursor: default; width:6%">昵称</th>
							<th style="cursor: default; width:6%">状态</th>
							<th style="cursor: default; width:6%">幸运数字</th>
							<th style="cursor: default; width:6%">IP</th>
							<th style="cursor: default; width:6%">所在地</th>
