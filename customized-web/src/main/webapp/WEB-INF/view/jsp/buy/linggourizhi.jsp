    ...
    <body>
    	<div id="admin">
    		<div class="ad-menu" id="ad-menu">
                <div class="ad-logo"> <img src="../image/m-logo.png" height="103" width="103"> </div>
                <div class="ad-list">
                    <ul>
                        <li>
                            ...
                            <dl>
                                <dd>
                                    <a href="../home/用户管理.html" class="dd-item">用户管理<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../home/商品管理.html" class="dd-item">商品管理<span class="scm dd-ar"></span></a>
                                </dd>
								<dd>
                                    <a href="../home/众筹.html" class="dd-item">众筹信息<span class="scm dd-ar"></span></a>
                                </dd>
								<dd>
                                    <a href="../home/充值.html"class="dd-item">充值订单管理<span class="scm dd-ar"></span></a>
                                </dd>
								<dd>
                                    <a href="../home/今日统计.html" class="dd-item">统计<span class="scm dd-ar"></span></a>
                                </dd>
								<dd>
                                    <a href="../home/中奖记录.html" class="dd-item">中奖记录<span class="scm dd-ar"></span></a>
                                </dd>
                            </dl>
                        </li>
                        <li>
                          ...
                          <dl>
                             <dd>
                                    <a href="../operating/开奖数据.html" class="dd-item">开奖数据<span class="scm dd-ar"></span></a>
                                   
                                </dd>
                          
                                <dd>
                                    <a href="../operating/消费记录.html" class="dd-item">消费记录<span class="scm dd-ar"></span></a>
                                   
                                </dd>
                                <dd>
                                    <a href="../operating/收货地址.html" class="dd-item">收货地址<span class="scm dd-ar"></span></a>
                                   
                                </dd>
                                <dd>
                                    <a href="../operating/IP黑名单.html" class="dd-item">IP黑名单<span class="scm dd-ar"></span></a>
                                   
                                </dd>
                                <dd>
                                    <a href="../operating/账户黑名单.html" class="dd-item">账户黑名单<span class="scm dd-ar"></span></a>
                        ...
                        <li>
                            ...
                            <dl>
                                <dd>
                                    <a href="../buy/零够日志.html" class="dd-item">零够日志<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../buy/零够记录.html" class="dd-item">零够记录<span class="scm dd-ar"></span></a>
                                </dd>
								 <dd>
                                    <a href="../buy/用户零够.html" class="dd-item">用户零够<span class="scm dd-ar"></span></a>
                                </dd>
                            </dl>
                        </li>
                        <li>
    		...
    		<div class="ad-comment-box" id="ad-comment">
                <div class="ad-top-comment">
                    ...
                    <div class="ad-main-nav-box">
                        <ul id="breadcrumbs-three">
                            <li title="首页"><a href="javascript:;" class="dot">零够日志 </a></li>
                        </ul>
                    ...
                    <div class="ad-sub-nav-box content-tabs">
                        ...
                        <div class="ad-sub-wraper page-tabs J_menuTabs">
                            <ul class="ad-sub-list page-tabs-content">
                                <li class="active J_menuTab" data-id=" ">零够日志</li>
                            </ul>
                        </div>
                ...
                <div class="ad-main-comment J_mainContent" id="ad-iframe">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="rizhi.jsp" frameborder="0" data-id="index_v0.jsp" seamless></iframe>
                </div>
    		</div>
    	</div>
