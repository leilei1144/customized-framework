...
<div style="display: block;text-align: left;">
                  ...
                  <input style="margin-bottom: 10px; " type="button" class="btn btn-primary" id="search-btn" value="搜 索">
                        ...
                        <tr role="row">
							...
							<th style="cursor: default; width:7%;">ID</th>
                            <th style="cursor: default; width:7%;">众筹ID</th>
                            <th style="cursor: col-resize; width:7%">商品名</th>
                            <th id="balance" style="cursor: col-resize; width:15%">购买时间<span class="sort"></span></th>
                            <th width="70px" style="cursor: default; width:15%">时间转化所得数字</th>
                            <th style="cursor: default; width:5%">用户帐户</th>
                            <th style="cursor: default; width:7%" >昵称</th>
                            <th width="70px" style="cursor: default; width:3%">更多</th>
