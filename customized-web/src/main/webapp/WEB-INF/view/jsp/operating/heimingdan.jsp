...
<div style="display: block;text-align: left;">
                  <input id="ghid" type="text" default_val="IP地址" value="IP地址" style="width:6%;">
				                   <select id="type" style="width:10%;">
                    <option value="-1">账户分类</option>
                    <option value="1">手机账号</option>
                    <option value="0">QQ账号</option>
                 ...
                 <select id="type" style="width:10%;">
				  ...
				  <input style="margin-bottom: 10px; margin-top:10px;" type="button" class="btn btn-primary" id="search-btn" value="添 加">
                        ...
                        <tr role="row">
                            ...
                            <th style="cursor: default; width:6%;">用户账户</th>
                            <th style="cursor: col-resize; width:6%">帐户分类</th>
                            <th id="balance" style="cursor: col-resize; width:9%">状态<span class="sort"></span></th>
							<th style="cursor: col-resize; width:6%">时间</th>
			...
			<div class="form-inline btn-toolbar">
                  <div class="reveal">
				   <span>
					...
					<button class="btn btn-primary" id="stop">停用</button>
					<button class="btn btn-primary" id="use">启用</button>
