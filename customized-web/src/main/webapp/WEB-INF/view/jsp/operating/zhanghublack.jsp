    	...
    	<div id="admin">
                        ...
                        <li>
                            ...
                            <dl>
                                ...
                                <dd>
								 ...
								 <dd>
                                    <a href="../#" class="dd-item">众筹信息<span class="scm dd-ar"></span></a>
                                </dd>
								 <dd>
                                    <a href="../#" class="dd-item">充值订单管理<span class="scm dd-ar"></span></a>
                                </dd>
								 <dd>
                                    <a href="../#" class="dd-item">统计<span class="scm dd-ar"></span></a>
                                </dd>								
                                <dd>
                                    <a href="../#" class="dd-item">中奖记录<span class="scm dd-ar"></span></a>
                                </dd>
                            </dl>
                        </li>
                        <li>
                            ...
                            <dl>
                                <dd>
                                    <a href="../#" class="dd-item">开奖数据<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">消费记录<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">收货地址<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">IP黑名单<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">账户黑名单<span class="scm dd-ar"></span></a>
                                </dd>
                            </dl>
                        </li>
                        <li>
                            ...
                            <dl>
                                <dd>
                                    <a href="../#" class="dd-item">Icon&banner <span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">ID占用管理<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">快速管理<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">在线参数<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">应用版本<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">系统配置<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../#" class="dd-item">充值渠道<span class="scm dd-ar"></span></a>
                                </dd>
                            </dl>
                        </li>
                        <li>
    		...
    		<div class="ad-comment-box" id="ad-comment">
                    ...
                    <div class="ad-sub-nav-box content-tabs">
                        ...
                        <div class="ad-sub-wraper page-tabs J_menuTabs">
                            <ul class="ad-sub-list page-tabs-content">
                                <li class="active J_menuTab" data-id=" ">账户黑名单</li>
                            </ul>
                        </div>
                ...
                <div class="ad-main-comment J_mainContent" id="ad-iframe">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="heimingdan.jsp" frameborder="0" data-id="index_v0.jsp" seamless></iframe>
                </div>
    		</div>
    	</div>
