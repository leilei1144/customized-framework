    	...
    	<div id="admin">
    		<div class="ad-menu" id="ad-menu">
                ...
                <div class="ad-list">
                    <ul>
                        ...
                        <li>
                            <div class="li-item"><em class="scm li-ico ic3"></em>配置管理<span class="scm arrow"></span></div>
                            <dl>
                                <dd>
                        ...
                        <li>
                            <div class="li-item"><em class="scm li-ico ic4"></em>权限管理<span class="scm arrow"></span></div>
                            <dl>
                                <dd>
    		...
    		<div class="ad-comment-box" id="ad-comment">
                <div class="ad-top-comment">
                    ...
                    <div class="ad-main-nav-box">
                        <ul id="breadcrumbs-three">
                            <li title="首页"><a href="javascript:;" class="dot">Icon&banner </a></li>
                        </ul>
                    ...
                    <div class="ad-sub-nav-box content-tabs">
                        ...
                        <div class="ad-sub-wraper page-tabs J_menuTabs">
                            <ul class="ad-sub-list page-tabs-content">
                                <li class="active J_menuTab" data-id="index_v0.jsp">Icon&banner </li>
                            </ul>
                        </div>
                ...
                <div class="ad-main-comment J_mainContent" id="ad-iframe">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="banner.jsp" frameborder="0" data-id="index_v0.jsp" seamless></iframe>
                </div>
    		</div>
    	</div>
