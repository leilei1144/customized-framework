...
<div style="display: block;text-align: left;">
				  ...
				  <input style="margin-bottom: 10px; margin-top:10px;" type="button" class="btn btn-primary" id="search-btn" value="添 加">
                        ...
                        <tr role="row">
							...
							<th style="cursor: default; width:4%;">ID</th>
                            <th style="cursor: default; width:4%;">参数名</th>
                            <th style="cursor: col-resize; width:20%">参数值</th>
                            <th id="balance" style="cursor: col-resize; width:9%">详细描述<span class="sort"></span></th>
							<th style="cursor: default; width:5%">应用名</th>
							<th style="cursor: default; width:5%">版本号</th>
							<th style="cursor: default; width:5%">更多</th>
                        </tr>
                        </thead>
