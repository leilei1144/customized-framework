                 ...
                 <select id="type" style="width:10%;">
				  ...
				  <input style="margin-bottom: 10px; margin-top:10px;" type="button" class="btn btn-primary" id="search-btn" value="添 加">
                        ...
                        <tr role="row">
                            ...
                            <th style="cursor: default; width:6%;">渠道名称</th>
                            <th style="cursor: col-resize; width:6%">显示名称</th>
                            <th id="balance" style="cursor: col-resize; width:9%">渠道图标<span class="sort"></span></th>
							<th style="cursor: col-resize; width:6%">热门图标</th>
							<th style="cursor: default; width:6%">活动图标</th>
							<th style="cursor: default; width:6%">中文描述</th>
							<th style="cursor: default; width:6%">排序</th>
							<th style="cursor: default; width:6%">启用状态</th>
							<th style="cursor: default; width:6%">APP</th>
							<th style="cursor: default; width:6%">APP名称</th>
							<th style="cursor: default; width:6%">version</th>
							<th style="cursor: default; width:6%">是否立即购买</th>
