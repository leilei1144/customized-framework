...
<div style="display: block;text-align: left;">
                  <input id="ghid" type="text" default_val="标题" value="标题" style="width:6%;">
				                   <select id="type" style="width:10%;">
                    <option value="-1">应用版本</option>
                    <option value="1">版本号1.0</option>
                    <option value="0">版本号1.1</option>
					<option value="2">版本号1.2</option>
					<option value="3">版本号2.0</option>
