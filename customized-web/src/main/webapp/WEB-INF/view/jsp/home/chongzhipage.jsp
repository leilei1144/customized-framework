    	...
    	<div id="admin">
    		<div class="ad-menu" id="ad-menu">
                ...
                <div class="ad-list">
                    <ul>
                        ...
                        <li>
                            ...
                            <dl>
                                <dd>
                                    <a href="../config/Icon&banner.jsp" class="dd-item">Icon&banner <span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../config/ID占用管理.jsp" class="dd-item">ID占用管理<span class="scm dd-ar"></span></a>
                                </dd>
                                 <dd>
                                    <a href="../config/快递管理.jsp" class="dd-item">快递管理<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../config/在线参数.jsp" class="dd-item">在线参数<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../config/应用版本.jsp" class="dd-item">应用版本<span class="scm dd-ar"></span></a>
                                </dd>
                                <dd>
                                    <a href="../config/系统配置.jsp" class="dd-item">系统配置<span class="scm dd-ar"></span></a>
                                </dd>																
                                <dd>
                                    <a href="../config/充值渠道.jsp" class="dd-item">充值渠道<span class="scm dd-ar"></span></a>
                                </dd>								
                            </dl>
                        </li>
                        <li>
                    ...
                    <div class="ad-sub-nav-box content-tabs">
                        ...
                        <div class="ad-sub-wraper page-tabs J_menuTabs">
                            <ul class="ad-sub-list page-tabs-content">
                                <li class="active J_menuTab" data-id=" ">充值订单</li>
                            </ul>
                        </div>
                ...
                <div class="ad-main-comment J_mainContent" id="ad-iframe">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="chongzhi.jsp" frameborder="0" data-id="index_v0.jsp" seamless></iframe>
                </div>
    		</div>
    	</div>
